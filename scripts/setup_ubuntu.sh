...
wget http://checkmk.mattconnley.com/homelab/check_mk/agents/check-mk-agent_2.3.0p6-1_all.deb -O /root/check-mk-agent_2.3.0p6-1_all.deb
dpkg -i /root/check-mk-agent_2.3.0p6-1_all.deb
rm /root/check-mk-agent_2.3.0p6-1_all.deb
